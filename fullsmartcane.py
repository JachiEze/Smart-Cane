...
threads = []
threads.append(threading.Thread(target=upload_cloud))
threads.append(threading.Thread(target=detect_objects))
threads.append(threading.Thread(target=ultrasonic_sensor))
threads.append(threading.Thread(target=water_sensor))
